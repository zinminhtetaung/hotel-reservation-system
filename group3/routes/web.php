...
)->name('userview.roomlist')->middleware('preventBackHistory');
Route::get('/user/booking/{id}',[OnlineBookingController::class,'createBooking'])
->name('booking.create')->middleware('preventBackHistory');
Route::post('/user/storeBooking',[OnlineBookingController::class,'storeBooking'])
->name('booking.store')->middleware('preventBackHistory');


/**
 * User routes
 */
Route::get('/users', [UserController::class, 'getUser'])->name('userlist')->middleware('preventBackHistory');
Route::post('/addUser', [UserController::class, 'addUser'])->name('user.create')->middleware('preventBackHistory');
Route::get('/users/{id}/update', [UserController::class, 'update'])->name('user.update')->middleware('preventBackHistory');
Route::post('/users/{id}/update', [UserController::class, 'updateUser'])->name('user.update')->middleware('preventBackHistory');
 ...
 * Show Graph
 */
Route::get('/graph', [ChartController::class, 'index'])->name('chart.index')->middleware('preventBackHistory');

/**
 * Hotel routes
 */
Route::get('/hotels/list', [HotelController::class, 'showHotelList'])->name('hotelList')->middleware('preventBackHistory');
 ...
 * Room routes
 */
Route::get('/rooms/list', [RoomController::class, 'showRoomList'])->name('roomList')->middleware('preventBackHistory');
Route::post('/rooms/create',  [RoomController::class, 'saveRoom'])->name('create.room')->middleware('preventBackHistory');
Route::delete('/rooms/{id}/delete', [RoomController::class, 'deleteRoomById']);
Route::get('/rooms/{id}/update', [RoomController::class, 'update'])->name('room.update')->middleware('preventBackHistory');
Route::post('/rooms/{id}/update', [RoomController::class, 'updateRoom'])->name('room.update')->middleware('preventBackHistory');
